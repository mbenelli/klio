...
; (namespace
;   ("assert#" assert)
;   ("utils#" cout cerr nl string-prefix string-rindex)
;   ("sxml-tools#" sxml:lookup sxml:ns-list)
;   ("sxpath-lib#" map-union nodeset? ntype?? sxml:attr-list sxml:attribute sxml:child
;    sxml:element? sxml:filter sxml:node?))

#;(using
 sxml
 (prelude : assert cout cerr nl)
 (string : string-prefix string-rindex))
