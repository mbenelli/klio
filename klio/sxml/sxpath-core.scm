...
;(include "sxpath-core#.scm")

;(namespace
;  ("assert#" assert)
;  ("and-let#" and-let*)
;  ("utils#" cerr)
;  ("sxml-tools#" sxml:attr)
;  ("sxpath-lib#" as-nodeset map-union node-eq? node-equal? node-pos node-self
;   nodeset? ntypes-names?? ntype-namespace-id?? ntype?? select-kids
;   sxml:complement sxml:filter sxml:node?)
;  ("sxpath-ext#" sxml-descendant sxml-descendant-or-self)
;  ("txpath#" sxml:xpath-expr))
...
;; $Id: sxpath-core.scm,v 1.1.2.1 2010/07/19 15:29:27 mbenelli-cvs Exp $
